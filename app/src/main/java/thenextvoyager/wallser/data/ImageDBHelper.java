...
public class ImageDBHelper extends SQLiteOpenHelper {
    ...
    private void addImage(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + ImageContract.ImageEntry.TABLE_NAME + " ("
                ...
                + ImageContract.ImageEntry.COLUMN_REGURL + " text NOT NULL," + ImageContract.ImageEntry.COLUMN_USERNAME + " text NOT NULL," + ImageContract.ImageEntry.COLUMN_PORTFOLIONAME + " text NOT NULL," + ImageContract.ImageEntry.COLUMN_PROFILEIMAGE + " text NOT NULL," + ImageContract.ImageEntry.COLUMN_DLDURL + " text NOT NULL);");
